...
export class ProductListComponent implements OnInit {
   ...
   * 
   * For desktop the source element is obtained from the previously called handleDragStart(), and on the drop event a drop index is provided of the landing element
   * This is used to update the order of the columns
   * 
   * For mobile first check that the original element and landing element are not the same via document.elementFromPoint() and the changedTouches value
